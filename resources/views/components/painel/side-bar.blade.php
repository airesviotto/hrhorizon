<div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <div class="flex justify-start items-center">
          ...
          <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
            <img
              ...
              alt="Flowbite Logo"
            />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">HR Horizon</span>
          </a>
    ...
    >
      ...
      <div class="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20">
        ...
        {{--tooltip message button profile--}}
        <div
          id="tooltip-profile"
          role="tooltip"
        ...
        {{--tooltip message button setting--}}
        <div
          id="tooltip-settings"
          role="tooltip"
          class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip"
